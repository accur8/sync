...
//  extends Logging
{
  ...
  private var argsOpt: Option[Seq[String]] = None

  def args: Seq[String] = argsOpt.get
  ...
  implicit def logger: Logger = LoggerFactory.logger(getClass.getName)
  ...
  def main(args: Array[String]): Unit = {
    ...
    argsOpt = Some(args.toIndexedSeq)
