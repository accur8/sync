...
import a8.shared.jdbcf.querydsl.QueryDsl.{LinkCompiler, Linker}
...
trait ComponentMapper[A] extends Mapper[A] {
  ...
  def structuralEquality(linker: QueryDsl.Linker, a: A)(implicit alias: LinkCompiler): QueryDsl.Condition
