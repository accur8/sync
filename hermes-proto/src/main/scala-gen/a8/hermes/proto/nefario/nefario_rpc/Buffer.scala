...
final case class Buffer(
    ...
    source: a8.hermes.proto.nefario.nefario_rpc.BufferSource = a8.hermes.proto.nefario.nefario_rpc.BufferSource.unspecified,
    ...
    def withSource(__v: a8.hermes.proto.nefario.nefario_rpc.BufferSource): Buffer = copy(source = __v)
    ...
    def companion: a8.hermes.proto.nefario.nefario_rpc.Buffer.type = a8.hermes.proto.nefario.nefario_rpc.Buffer
    // @@protoc_insertion_point(GeneratedMessage[nefario_rpc.Buffer])
}

object Buffer extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.nefario.nefario_rpc.Buffer] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[a8.hermes.proto.nefario.nefario_rpc.Buffer] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): a8.hermes.proto.nefario.nefario_rpc.Buffer = {
    ...
    var __source: a8.hermes.proto.nefario.nefario_rpc.BufferSource = a8.hermes.proto.nefario.nefario_rpc.BufferSource.unspecified
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 24 =>
          __source = a8.hermes.proto.nefario.nefario_rpc.BufferSource.fromValue(_input__.readEnum())
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[a8.hermes.proto.nefario.nefario_rpc.Buffer] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      a8.hermes.proto.nefario.nefario_rpc.Buffer(
        ...
        source = a8.hermes.proto.nefario.nefario_rpc.BufferSource.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(a8.hermes.proto.nefario.nefario_rpc.BufferSource.unspecified.scalaValueDescriptor).number)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = NefarioRpcProto.javaDescriptor.getMessageTypes().get(9)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = NefarioRpcProto.scalaDescriptor.messages(9)
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 3 => a8.hermes.proto.nefario.nefario_rpc.BufferSource
    }
  }
  lazy val defaultInstance = a8.hermes.proto.nefario.nefario_rpc.Buffer(
    timestamp = _root_.scala.None,
    data = _root_.com.google.protobuf.ByteString.EMPTY,
    source = a8.hermes.proto.nefario.nefario_rpc.BufferSource.unspecified
  )
  implicit class BufferLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, a8.hermes.proto.nefario.nefario_rpc.Buffer]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, a8.hermes.proto.nefario.nefario_rpc.Buffer](_l) {
    ...
    def source: _root_.scalapb.lenses.Lens[UpperPB, a8.hermes.proto.nefario.nefario_rpc.BufferSource] = field(_.source)((c_, f_) => c_.copy(source = f_))
  }
  ...
  def of(
    ...
    source: a8.hermes.proto.nefario.nefario_rpc.BufferSource
  ): _root_.a8.hermes.proto.nefario.nefario_rpc.Buffer = _root_.a8.hermes.proto.nefario.nefario_rpc.Buffer(
    timestamp,
    data,
    source
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[nefario_rpc.Buffer])
}
