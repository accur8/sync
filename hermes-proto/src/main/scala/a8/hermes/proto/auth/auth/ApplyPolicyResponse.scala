...
object ApplyPolicyResponse extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.auth.auth.ApplyPolicyResponse] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AuthProto.javaDescriptor.getMessageTypes().get(33)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AuthProto.scalaDescriptor.messages(33)
