...
object AddChannelResponse extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.process.wsmessages.AddChannelResponse] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = WsmessagesProto.javaDescriptor.getMessageTypes().get(44)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = WsmessagesProto.scalaDescriptor.messages(44)
