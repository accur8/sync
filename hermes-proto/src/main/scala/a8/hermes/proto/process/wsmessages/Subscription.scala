...
final case class Subscription(
    oneof: a8.hermes.proto.process.wsmessages.Subscription.Oneof = a8.hermes.proto.process.wsmessages.Subscription.Oneof.Empty,
    unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[Subscription] {
    @transient
    private[this] var __serializedSizeMemoized: _root_.scala.Int = 0
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      var __size = 0
      if (oneof.mailbox.isDefined) {
      ...
      if (oneof.changeDataCapture.isDefined) {
        val __value = oneof.changeDataCapture.get
        __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      };
      if (oneof.unsubscribe.isDefined) {
        val __value = oneof.unsubscribe.get
        __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      };
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      oneof.changeDataCapture.foreach { __v =>
        val __m = __v
        _output__.writeTag(3, 2)
        _output__.writeUInt32NoTag(__m.serializedSize)
        __m.writeTo(_output__)
      };
      oneof.unsubscribe.foreach { __v =>
        val __m = __v
    ...
    def withUnsubscribe(__v: a8.hermes.proto.process.wsmessages.Unsubscribe): Subscription = copy(oneof = a8.hermes.proto.process.wsmessages.Subscription.Oneof.Unsubscribe(__v))
    def clearOneof: Subscription = copy(oneof = a8.hermes.proto.process.wsmessages.Subscription.Oneof.Empty)
    def withOneof(__v: a8.hermes.proto.process.wsmessages.Subscription.Oneof): Subscription = copy(oneof = __v)
...
object Subscription extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.process.wsmessages.Subscription] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[a8.hermes.proto.process.wsmessages.Subscription] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): a8.hermes.proto.process.wsmessages.Subscription = {
    var __oneof: a8.hermes.proto.process.wsmessages.Subscription.Oneof = a8.hermes.proto.process.wsmessages.Subscription.Oneof.Empty
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 34 =>
          __oneof = a8.hermes.proto.process.wsmessages.Subscription.Oneof.Unsubscribe(__oneof.unsubscribe.fold(_root_.scalapb.LiteParser.readMessage[a8.hermes.proto.process.wsmessages.Unsubscribe](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[a8.hermes.proto.process.wsmessages.Subscription] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = a8.hermes.proto.process.wsmessages.Subscription(
    oneof = a8.hermes.proto.process.wsmessages.Subscription.Oneof.Empty
  )
  sealed trait Oneof extends _root_.scalapb.GeneratedOneof {
  ...
  object Oneof {
    @SerialVersionUID(0L)
    case object Empty extends a8.hermes.proto.process.wsmessages.Subscription.Oneof {
    ...
    @SerialVersionUID(0L)
    final case class Mailbox(value: a8.hermes.proto.process.wsmessages.MailboxSubscription) extends a8.hermes.proto.process.wsmessages.Subscription.Oneof {
      type ValueType = a8.hermes.proto.process.wsmessages.MailboxSubscription
      override def isMailbox: _root_.scala.Boolean = true
      override def mailbox: _root_.scala.Option[a8.hermes.proto.process.wsmessages.MailboxSubscription] = Some(value)
    ...
    @SerialVersionUID(0L)
    final case class ChangeDataCapture(value: a8.hermes.proto.process.wsmessages.ChangeDataCaptureSubscription) extends a8.hermes.proto.process.wsmessages.Subscription.Oneof {
      type ValueType = a8.hermes.proto.process.wsmessages.ChangeDataCaptureSubscription
      override def isChangeDataCapture: _root_.scala.Boolean = true
      override def changeDataCapture: _root_.scala.Option[a8.hermes.proto.process.wsmessages.ChangeDataCaptureSubscription] = Some(value)
      override def number: _root_.scala.Int = 3
    }
    @SerialVersionUID(0L)
    final case class Unsubscribe(value: a8.hermes.proto.process.wsmessages.Unsubscribe) extends a8.hermes.proto.process.wsmessages.Subscription.Oneof {
      type ValueType = a8.hermes.proto.process.wsmessages.Unsubscribe
      override def isUnsubscribe: _root_.scala.Boolean = true
      override def unsubscribe: _root_.scala.Option[a8.hermes.proto.process.wsmessages.Unsubscribe] = Some(value)
  ...
  def of(
    oneof: a8.hermes.proto.process.wsmessages.Subscription.Oneof
