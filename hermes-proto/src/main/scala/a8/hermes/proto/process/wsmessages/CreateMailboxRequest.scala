...
object CreateMailboxRequest extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.process.wsmessages.CreateMailboxRequest] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = WsmessagesProto.javaDescriptor.getMessageTypes().get(33)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = WsmessagesProto.scalaDescriptor.messages(33)
