...
object CreateMailboxResponse extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.process.wsmessages.CreateMailboxResponse] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = WsmessagesProto.javaDescriptor.getMessageTypes().get(42)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = WsmessagesProto.scalaDescriptor.messages(42)
