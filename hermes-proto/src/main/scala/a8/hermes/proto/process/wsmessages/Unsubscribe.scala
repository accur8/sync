...
object Unsubscribe extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.process.wsmessages.Unsubscribe] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = WsmessagesProto.javaDescriptor.getMessageTypes().get(40)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = WsmessagesProto.scalaDescriptor.messages(40)
