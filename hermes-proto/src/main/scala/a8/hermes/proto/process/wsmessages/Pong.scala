...
final case class Pong(
    ...
    def withPayload(__v: _root_.com.google.protobuf.ByteString): Pong = copy(payload = __v)
...
object Pong extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.process.wsmessages.Pong] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[a8.hermes.proto.process.wsmessages.Pong] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): a8.hermes.proto.process.wsmessages.Pong = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[a8.hermes.proto.process.wsmessages.Pong] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = a8.hermes.proto.process.wsmessages.Pong(
    payload = _root_.com.google.protobuf.ByteString.EMPTY
  )
  implicit class PongLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, a8.hermes.proto.process.wsmessages.Pong]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, a8.hermes.proto.process.wsmessages.Pong](_l) {
