...
final case class ProcessStartedRequest(
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      if (discovery.isDefined) {
        val __value = discovery.get
        __size += 2 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      };
      
      {
        val __value = isUpdate
        if (__value != false) {
    ...
    def companion: a8.hermes.proto.continuum.continuum_rpc.ProcessStartedRequest.type = a8.hermes.proto.continuum.continuum_rpc.ProcessStartedRequest
    // @@protoc_insertion_point(GeneratedMessage[continuum_rpc.ProcessStartedRequest])
}

object ProcessStartedRequest extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.continuum.continuum_rpc.ProcessStartedRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[a8.hermes.proto.continuum.continuum_rpc.ProcessStartedRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): a8.hermes.proto.continuum.continuum_rpc.ProcessStartedRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[a8.hermes.proto.continuum.continuum_rpc.ProcessStartedRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ContinuumRpcProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ContinuumRpcProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 6 => __out = com.google.protobuf.timestamp.Timestamp
      case 19 => __out = a8.hermes.proto.discovery.discovery.DiscoveryResponse
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = a8.hermes.proto.continuum.continuum_rpc.ProcessStartedRequest(
    processUid = "",
    parentProcessRunUid = "",
    processPid = 0,
    workerUid = "",
