...
final case class ProcessCompletedRequest(
    ...
    def companion: a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest.type = a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest
    // @@protoc_insertion_point(GeneratedMessage[nefario_rpc.ProcessCompletedRequest])
}

object ProcessCompletedRequest extends scalapb.GeneratedMessageCompanion[a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = NefarioRpcProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = NefarioRpcProto.scalaDescriptor.messages(4)
  ...
  lazy val defaultInstance = a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest(
    processUid = "",
    exitCode = 0,
    exitMessage = "",
    completedAt = _root_.scala.None
  )
  implicit class ProcessCompletedRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest](_l) {
  ...
  ): _root_.a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest = _root_.a8.hermes.proto.nefario.nefario_rpc.ProcessCompletedRequest(
    processUid,
    exitCode,
    exitMessage,
    completedAt
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[nefario_rpc.ProcessCompletedRequest])
}
