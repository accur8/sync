...
object UInt64Value extends scalapb.GeneratedMessageCompanion[com.google.protobuf.wrappers.UInt64Value] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.google.protobuf.wrappers.UInt64Value = {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[google.protobuf.UInt64Value])
}
