...
final case class DoubleValue(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[DoubleValue] {
    @transient
...
object DoubleValue extends scalapb.GeneratedMessageCompanion[com.google.protobuf.wrappers.DoubleValue] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.google.protobuf.wrappers.DoubleValue = {
